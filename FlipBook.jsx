...
const FlipBook = () => {
  ...
  // Helper function to get watermarked image URL - only for gallery images
  const getWatermarkedImageUrl = (originalUrl, isGalleryImage = false) => {
    if (isGalleryImage) {
            ...
            <div className="mb-3 flex flex-col items-center">
              ...
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  className="rounded-xl shadow-xl border-4 border-white bg-white mb-1 pointer-events-none"
                  onContextMenu={(e) => e.preventDefault()}
                  draggable="false"
                />
              </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 md:gap-6 max-w-7xl mx-auto">
            {product.images.map((image, index) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-green-50">
                  <Image
                    src={getWatermarkedImageUrl(image || "/placeholder.svg?height=300&width=400", true)}
                    alt={`${product.title} ${index + 1}`}
                    fill
    ...
    return (
      ...
      >
        ...
        <div className="relative w-[90vw] h-[90vh] overflow-hidden flex items-center justify-center">
          ...
          >
            <Image
              src={getWatermarkedImageUrl(imageUrl || "/placeholder.svg?height=800&width=600", true)}
              alt={product.title}
              fill
              style={{ objectFit: "contain" }} // Image initially fits the motion.div
              className="pointer-events-none"
