...
const FlipBook = () => {
  ...
  const productData = {
    ...
    "bio-200ml": {
      title: "Biodegradable 200ml",
      images: ["/bio/200ml bio.jpeg"],
    },
    "bio-250ml": {
      title: "Biodegradable 250ml",
      images: ["/bio/250ml bio.jpeg"],
    },
    "bio-300ml": {
      title: "Biodegradable 300ml",
      images: ["/bio/300ml bio.jpeg"],
    },
    "bio-500ml": {
      title: "Biodegradable 500ml",
      images: ["/bio/500ml bio.jpeg"],
    },
    "bio-750ml": {
      title: "Biodegradable 750ml",
      images: ["/bio/750ml bio.jpeg"],
    },
  }
  ...
  const shouldWatermarkImage = (imagePath) => {
            ...
            >
              <motion.div whileHover={{ scale: 1.1, rotate: 5 }} transition={{ duration: 0.3 }}>
                <Image
                  ...
                  width={70}
                  height={70}
                  className="rounded-lg shadow-md border-2 border-white pointer-events-none"
                  onContextMenu={(e) => e.preventDefault()}
                  draggable="false"
                />
              </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 md:gap-6 max-w-7xl mx-auto">
            {product.images.map((image, index) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-green-50">
                  <Image
                    src={getImageUrl(image) || "/placeholder.svg?height=300&width=400"}
                    alt={`${product.title} ${index + 1}`}
                    fill
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = image || "/placeholder.svg?height=300&width=400"
                    }}
                  />
                  {/* Overlay on hover */}
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all duration-300 flex items-center justify-center pointer-events-auto">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-white/90 px-3 py-1 rounded-full text-sm font-medium text-gray-800">
                      Click to zoom
                    </div>
                  </div>
    ...
    return (
      ...
      >
        ...
        <div className="relative w-[90vw] h-[90vh] overflow-hidden flex items-center justify-center">
          ...
          >
            <Image
              src={getImageUrl(imageUrl) || "/placeholder.svg?height=800&width=600"}
              alt={product.title}
              fill
              style={{ objectFit: "contain" }}
              className="pointer-events-none"
